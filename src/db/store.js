...
const updateStorage = (data) => {
    localStorage.setItem('contacts', JSON.stringify(data)); // JSON.stringfy -> json object to string 
}

// store logic
export const createContact = (contact) => {
    // check if mail exists in db or not
    ...
    if(extEmail) {
        ...
        // if mobile and email not exists -> store new contact data in local stotage
