...
function Create (props) {
   ...
   const submitHandler = async (e) => {
    ...
    return(
        // how to declare the states 
        // const [state,handler()] = useState(initialValues)
        // 
                        ...
                        <div className="card-body">
                            <form autoComplete="off" onSubmit={submitHandler}>
                                <div className="form-group mt-2">
                                    ...
                                    <input type="text" name="name" value={ fname } onChange={(e) => setFName(e.target.value)}  id="name" className="form-control" required />
                                </div>
                                <div className="form-group mt-2">
                                ...
                                <div className="form-group mt-2">
                                    ...
                                    <textarea type="address" name="address" value={ faddress } onChange={(e) => setFAddress(e.target.value)} id="address" cols="30" rows="5" className="form-control" required></textarea>
                                </div>
                                <div className="form-group mt-2">
